...
export const blogs = [
  {
    ...
    story: (
      <p>
        ...
        a time.
        <br /> The band came down to East Bay Recorders to track songs that were
        ten years in the making. "American Ghost Town" came out in April of
  ...
  },
  {
    ...
    story: (
      <p>
        ...
        happy."
        <br />
        Rosen is talking about the Charger recording dates — a new metal
        influenced punk band fronted by Rancid’s Matt Freeman. Drummer Jason
        Willer and guitarist Andrew McGee round out the trio. Think Motorhead
        meets Rancid meets Pantera, Rosen offers.
        <br />
        The band put down seven songs at East Bay Recorders earlier this year.
        "It’s super intricate music,” Rosen says, “with lots of changes, stops,
        and things going on. Plus, we had to make sure you can hear Matt since
        it’s all about the rhythm section.
        <br />
        ”Rosen has worked with Freeman since Rancid’s 1994 release “Let’s Go.”
        <br />
        “It was so much fun because when you work in a band like Rancid for so
        many years, there are a particular set of rules when you do a record,”
        reports Rosen. “To see somebody who I think is an amazing musician step
        out and do something, like they’re doing it for the first time with all
        that joy, was so great.
        <br />
  ...
  },
  {
    ...
    story: (
      <p>
        ...
        full-length record.
        <br />
        Produced by Lars Frederiksen and engineered by Michael Rosen, this
        collection of songs was recorded with more intensity. “The songwriting
        and lyrics are a little deeper,” reports Rosen. “Lars is really into
        Danish folk heroes, and he writes about his Danish heritage on these
        songs. The band tours a lot and they sound amazing.”
        <br /> The band wanted a particular sound — an old metal record meets a
        new punk rock record. “We spent a lot of time on it,” Rosen says, “even
        down to the pacing of the record. We created segues from song to song.
        It was pretty intricate.”
        <br /> With a semi-serious laugh, Rosen admits that he can’t talk about
  ...
  },
  {
    ...
    story: (
      <p>
        ...
        2017.
        <br />
        “It was a new school project where they sent me the files, and I’d mix
        them here, then send Lars an MP3 for notes, then send an MP3 to the
        band,” Rosen says.
        <br />
        Singer Colin Abrahall told Heavy: “We laid down all kinds of takes on
        the songs which made the mixing interesting as we’d send it all off to
        Michael (Rosen – Engineer) and him and Lars (Fredericksen – Rancid)
  ...
  },
  {
    ...
    story: (
      <p>
        ...
        with cool moments that kept the entire team on their toes.
        <br />
        “Matthew is a first take producer, which is old school and cool,” Rosen
        recalls. “He’s got this trick where he makes the drummer play without
        cymbals on the first run. Then we’d go back and overdub the crashes and
        other stuff. It kept the tracks super clean. I don’t do that with
  ...
  },
  {
    ...
    story: (
      <p>
        ...
        performance and then he added it to the mix.
        <br />
        Joe, Rosen says, was interested in experimenting and finding a way to
        make a song cool. “His attitude was, ‘If it doesn’t sound right then
        don’t do it.’ He had no problem with flipping stuff up. In one verse we
        dropped the drums out. He’s like, ‘Why not?’ “It was cool to try
        something different and go in another direction,” Rosen continues. “It
